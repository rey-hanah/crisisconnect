...
const STEPS = [
  {
    ...
    body: "Sign up in less than a minute so we can show you relevant activity in your area.",
  },
  {
    title: "Choose your role: Need or Offer",
    body: "Post what you need, or let others know what you can provide — from water and food to transport, shelter, or medical support.",
  },
  {
    title: "Get matched faster",
    body: "Our system highlights urgent requests and surfaces the most relevant posts first, so help can move quickly.",
  },
  {
    title: "Connect and coordinate",
    body: "Use in-app chat to confirm details, arrange pickup/drop-off, and keep communication clear and secure.",
  },
  {
    title: "Close the loop",
    body: "Mark requests as fulfilled so your community sees what's resolved and what still needs support.",
  },
]
  ...
  return (
    <div ref={containerRef} className="w-full overflow-x-hidden">
      ...
      <section className="relative min-h-screen w-full overflow-hidden bg-background flex">
        ...
        <div ref={contentRef} className="relative z-10 flex flex-col justify-between w-1/2 px-8 md:px-14 lg:px-20 py-20 min-h-screen">
          ...
          <div className="flex flex-col justify-center flex-1">
            <h1 className="font-serif font-black uppercase leading-[0.85] tracking-tight text-foreground"
              style={{ fontSize: "clamp(2.5rem, 7vw, 7rem)" }}>
              HELP FINDS<br /><span className="text-primary">PEOPLE</span>
            </h1>
          ...
          <button ref={ctaRef} onClick={() => { window.location.href = "/login" }}
            ...
            <span className="font-mono text-[11px] font-bold text-foreground uppercase tracking-[0.22em]">Start Here</span>
          </button>
        </div>

        <div ref={mapRef} className="w-1/2 relative self-stretch -ml-16">
          <div className="absolute inset-0"><DottedMap markers={MARKERS} /></div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center overflow-hidden">
          <div className="flex-1 min-w-0">
            ...
            <h2 className="font-serif font-black uppercase tracking-tight text-foreground leading-[0.9] mb-8"
              ...
              BUILT FOR<br />THE WORST<br /><span style={{ color: "oklch(0.72 0.15 55)" }}>MOMENTS</span>
            </h2>
            <div className="space-y-5 max-w-md">
              <p className="text-sm text-muted-foreground leading-relaxed">
                In 2024, <span className="text-foreground font-medium">393 disasters</span> affected over
                167 million people worldwide, causing $242 billion in damages — yet only 43% of the
                required humanitarian funding was received.
              </p>
              <p className="text-sm text-muted-foreground leading-relaxed">
                CrisisConnect bridges that gap directly. Our AI triage engine scores every request by
                urgency in real time, surfacing critical needs first.
              </p>
              <p className="text-sm text-muted-foreground leading-relaxed">
                When official channels are overwhelmed, peer-to-peer coordination saves lives.
                We built the infrastructure to make that happen at scale.
              </p>
            </div>
          ...
          <div className="w-full lg:w-[52%] flex-shrink-0 flex flex-col gap-6">
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              <div className="mb-4">
                <p className="font-mono text-[9px] text-muted-foreground uppercase tracking-widest">People affected by disasters</p>
                <p className="font-serif text-2xl font-black text-foreground mt-1">
                  167M <span className="text-base" style={{ color: "oklch(0.72 0.15 55)" }}>↑ 75%</span>
                </p>
